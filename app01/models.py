...
class Order(models.Model):
    ...
    title = models.CharField(verbose_name="名称", max_length=32, null=True)
    price = models.IntegerField(verbose_name="价格", null=True)
    status_choices = (
        (1, "待支付"),
        (2, "已支付"),
    )
    status = models.SmallIntegerField(verbose_name="状态", choices=status_choices, default=1, null=True)
